...
export default async function Book({params}){
    ...
    return <div className="text-white grid gap-2 place-items-center">
        ...
        src={foundBookbook.book[0].cover===''?'/nocover.png':foundBookbook.book[0].cover}/>
    ...
    : <p className="text-white">Book doesn't exist</p>}
     ...
     <Link className="text-white" href={'/search'}> Go back toSearch</Link>
